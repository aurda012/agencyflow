...
const HomePage = () => {
  return (
    <div className="h-full">
      ...
      <section>
        <MaxWidthWrapper className="flex items-center flex-col gap-4 mt-8 md:mt-16">
          <h2 className="text-4xl text-center font-medium mb-2">
      ...
      <div className="h-[25rem] lg:h-[30rem] xl:h-[40rem] w-full rounded-md relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-2xl mx-auto p-4">
          <h1 className="relative z-10 text-2xl sm:text-4xl md:text-5xl lg:text-6xl pb-4  bg-clip-text text-transparent bg-gradient-to-b from-neutral-600 to-black  dark:from-neutral-400 dark:to-white text-center font-sans font-bold">
            Join AgencyFlow
          </h1>
          <p></p>
